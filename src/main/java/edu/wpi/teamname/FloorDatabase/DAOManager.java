...
public class DAOManager extends DAOImpl implements DAO_I {
	...
	/**
	 * Constructs the ORM from the SQL table remote database. It constructs a HashMap<String nodeID, Node node> that
	 * represents the name of the node and then the actual node itself which contains all the data and a Hashmap<String
	 * nodeID, HashSet<String nodeID>> that represents the name of a node and then the list of nodes that are accessible
	 * from that node
	 *
	...
	/**
	 * Constructs the HashMap that represents the nodes in the database. See constructLocalDatabase() for more details
	 * @throws SQLException
	 */
	...
	/**
	 * Constructs the HashMap that represents the edges in the database. See constructLocalDatabase() for more details
	 * @throws SQLException
	 */
	 ...
	 * @throws SQLException throws this exception if there is an issue with connecting to the database or there is a
	 *                      similar but related error
	 */
